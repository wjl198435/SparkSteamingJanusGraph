...
//        }
//
//       // GraphOfTheGodsFactory.class.getResource("resources/graph/janusgraph-cassandra-es.properties");
//
//        //Path graphconf=Paths.get("resources/graph/janusgraph-cassandra-es.properties");
//        //System.out.println(graphconf.toAbsolutePath().toString());
//        //System.out.println( GraphOfTheGodsFactory.class.getResource("/src/main/resources/graph/janusgraph-cassandra-es.properties"));
//        //GraphOfTheGodsFactory.getClass().getResource("log4j.properties");
//
//        JanusGraph g = JanusGraphFactory.open("/Hadoop/Janusgraph/janusgraph-0.3.1-hadoop2/conf/janusgraph-cassandra-es.properties");
//        load(g);
//        g.close();
//    }
//}
